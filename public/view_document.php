...
<div class="py-6">
    ...
    <div class="mx-auto px-4 sm:px-6 md:px-8">
        ...
        <div id="markAsDoneForm" class="hidden bg-white shadow rounded-lg p-4 mt-4">
            ...
            <form action="../process/mark_done_process.php" method="POST">
                <input type="hidden" name="document_id" value="<?= $documentId; ?>">
                
                <div class="mb-4">
                    <label for="comment" class="block text-sm font-medium text-gray-700 mb-1">Note (Optional)</label>
                    <textarea id="comment" name="comment" rows="3" class="shadow-sm focus:ring-primary-500 focus:border-primary-500 block w-full sm:text-sm border-gray-300 rounded-md" placeholder="Add any notes about the completed document..."></textarea>
                </div>
