...
try {
    ...
    // 1. Document submitter (client or contractor)
    ...
    if ($user['role'] !== 'admin' && 
        ...
        header('Location: ' . (in_array($user['role'], ['client', 'contractor']) ? 'client_dashboard.php' : 'dashboard.php'));
        exit;
    }
        ...
        <div class="bg-white overflow-hidden shadow-lg rounded-lg">
            ...
            <div class="p-6">
                ...
                <div class="mt-6 pt-6 border-t border-gray-200 flex flex-wrap gap-3">
                    <?php if (hasRole(['admin', 'supervisor', 'manager']) && $document['status'] === 'pending'): ?>
                    ...
                    <a href="download.php?id=<?= $document['id']; ?>" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 ml-2 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                        <i class="fas fa-download mr-2 text-primary-500"></i> Download PDF
                    </a>
                    <?php endif; ?>
                </div>
                <?php else: ?>
