...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'], $_POST['document_id'])) {
    ...
    try {
        ...
        $details = "Document ID: " . $_POST['document_unique_id'];
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <div class="mb-6">
                            <a href="../uploads/<?= htmlspecialchars($singleDocument['file_path']); ?>" target="_blank" class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50">
                                <i class="fas fa-eye mr-2"></i> View Document
                            </a>
                            <a href="../uploads/<?= htmlspecialchars($singleDocument['file_path']); ?>" download class="inline-flex items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 ml-2">
