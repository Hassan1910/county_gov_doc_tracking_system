        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                ...
                <div class="hidden md:flex space-x-4">
                    ...
                    <a href="../public/upload.php" class="<?= $current_page === 'upload.php' ? 'border-b-2 border-white' : '' ?> hover:text-primary-200 px-3 py-2">
                ...
                <div class="flex items-center space-x-2">
                    <?php if(isLoggedIn() && $current_user['role'] === 'client'): ?>
                    ...
                    <div class="relative group mr-3">
                        ...
                        <div class="absolute right-0 mt-2 w-80 sm:w-96 bg-white rounded-md shadow-lg py-1 z-20 hidden group-hover:block max-h-96 overflow-y-auto transform origin-top-right lg:origin-top-right md:right-0 sm:right-0 xs:right-0 dropdown-menu">
                    ...
                    <div class="relative group">
                        <button class="flex items-center hover:text-primary-200 focus:outline-none">
    ...
    <div class="md:hidden bg-primary-800 text-white">
        <div class="container mx-auto px-4 py-2 flex flex-wrap justify-center space-x-2">
            ...
            <a href="../public/notifications.php" class="<?= $current_page === 'notifications.php' ? 'bg-primary-600' : '' ?> hover:bg-primary-600 px-3 py-1 rounded my-1 relative">
                ...
                <?php if($unreadCount > 0): ?>
                <span class="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 bg-red-500 text-white rounded-full text-xs w-4 h-4 flex items-center justify-center" style="font-size: 0.6rem;"><?= $unreadCount > 9 ? '9+' : $unreadCount; ?></span>
                <?php endif; ?>
            </a>
            <?php else: ?>
            ...
            <a href="../public/upload.php" class="<?= $current_page === 'upload.php' ? 'bg-primary-600' : '' ?> hover:bg-primary-600 px-3 py-1 rounded my-1">
