...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Get user data
        $user = $stmt->fetch();
        // DEBUG: Log fetched user and password hashes
        error_log('LOGIN FETCHED USER: ' . print_r($user, true));
        error_log('LOGIN PASSWORD POST: ' . $password);
        error_log('LOGIN PASSWORD HASH: ' . $user['password']);
